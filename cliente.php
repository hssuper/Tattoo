<?php
include_once "include/menucliente.php";
?>
    ...
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" height="400px" width="400px" src="img/tattoo3.jpg" alt="Primeiro Slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" height="400px" width="400px" src="img/tattoo2.jpg" alt="Segundo Slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100 " height="400px" width="400px" src="img/tattoo1.png " alt="Terceiro Slide">
            </div>
        </div>
